...
export type WorkType = "book" | "newsletter" | "brand" | "social" | "note";
...
const SOCIAL: WorkVocab = {
  ...
  setup: "Compose",
  home: "/studio/social",
  newHref: "/studio/social/new",
  brainstormHref: "/studio/social/brainstorm",
  trashHref: "/studio/social/trash",
};

const NOTE: WorkVocab = {
  type: "note",
  work: "Note",
  workLower: "note",
  unit: "Note",
  ...
  setup: "Notes",
  home: "/studio/notes",
  newHref: "/studio/notes",
  brainstormHref: "/studio/notes",
  trashHref: "/studio/notes",
};
